      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <motion.div
            ...
            className="w-24 h-24 bg-gradient-to-br from-red-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg shadow-purple-500/50"
          >
        ...
        {/* Tytuł */}
        <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-purple-600 text-center mb-4">
          Dostęp Ograniczony
        </h1>
        ...
        <div className="space-y-4 text-gray-300 text-center mb-8">
          ...
          <p className="text-lg">
            Musisz mieć ukończone <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-purple-600 font-bold">18 lat</span>, aby uzyskać dostęp do tej witryny.
          </p>
        </div>

        {/* Dodatkowe informacje */}
        <div className="bg-purple-900/20 border border-purple-500/30 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-purple-600 mb-3">Dlaczego to ograniczenie?</h2>
