  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-black to-purple-900 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-gradient-to-br from-gray-900 to-black border-2 border-red-500/50 rounded-2xl p-8 max-w-2xl w-full shadow-2xl shadow-red-500/20"
      >
        {/* Icon */}
        <div className="flex justify-center mb-6">
          <motion.div
            ...
            className="w-24 h-24 bg-gradient-to-br from-red-600 to-red-800 rounded-full flex items-center justify-center shadow-lg shadow-red-500/50"
          >
        ...
        <div className="space-y-4 text-gray-300 text-center mb-8">
          ...
          <p className="text-lg">
            Musisz mieć ukończone <span className="text-red-400 font-bold">18 lat</span>, aby uzyskać dostęp do tej witryny.
          </p>
        </div>

        {/* Dodatkowe informacje */}
        <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold text-red-400 mb-3">Dlaczego to ograniczenie?</h2>
